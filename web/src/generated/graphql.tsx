...
export type PostSnippetFragment = { __typename?: "Post" } & Pick<
  ...
  | "voteStatus"
> & {
    creator: { __typename?: "User" } & Pick<User, "id" | "username" | "avatar">;
  };
...
export type AvatarMutation = { __typename?: "Mutation" } & {
  chooseAvatar: { __typename?: "User" } & Pick<User, "avatar">;
};
...
export type GetAvatarQuery = { __typename?: "Query" } & {
  avatar?: Maybe<{ __typename?: "User" } & Pick<User, "avatar">>;
};
...
export function useAvatarMutation() {
  return Urql.useMutation<AvatarMutation, AvatarMutationVariables>(
    AvatarDocument
  );
}
...
export function useGetAvatarQuery(
  options: Omit<Urql.UseQueryArgs<GetAvatarQueryVariables>, "query"> = {}
) {
  return Urql.useQuery<GetAvatarQuery>({
